...
api = HfApi(token=os.getenv("HF_TOKEN")) # Corrected: using HF_TOKEN environment variable
DATASET_PATH = "hf://datasets/SunnyShaurya/bank-customer-churn/bank_customer_churn.csv"
...
for file_path in files:
    api.upload_file(
        ...
        repo_id="SunnyShaurya/bank-customer-churn",
        repo_type="dataset",
    )
