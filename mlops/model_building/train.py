...
api = HfApi(token=os.getenv("HF_TOKEN")) # Ensure API client is initialized with token from start

Xtrain_path = "hf://datasets/SunnyShaurya/bank-customer-churn/Xtrain.csv"
Xtest_path = "hf://datasets/SunnyShaurya/bank-customer-churn/Xtest.csv"
ytrain_path = "hf://datasets/SunnyShaurya/bank-customer-churn/ytrain.csv"
ytest_path = "hf://datasets/SunnyShaurya/bank-customer-churn/ytest.csv"
...
repo_id = "SunnyShaurya/churn-model"
repo_type = "model"

# api = HfApi(token=os.getenv("HF_TOKEN")) # Already initialized above
